...
<script type="text/javascript">
	...
	map.centerAndZoom(new BMap.Point(121.858965,30.988379), 17);  // 初始化地图,设置中心点坐标和地图级别	
	...
	var infoWindow = new BMap.InfoWindow("地址：江苏省昆山市庆丰西路639号智谷创意工业园301", opts);  // 创建信息窗口对象 
